<template>
  <div class="pa-3">
    ...
    Hey! I'm a Full-Stack Developer currently located in Dallas, Tx. Before
    finding my passion in web development, I studied graphic design and
    understand the impact a great design can have. I strive to deliver products
    where development and design come together to provide intuitive UX with
    streamlined programs. As an aircraft mechanic, I learned to sharpen my
    attention to detail and I use that skill everyday to tackle any problems
    that need solving. If I'm not grinding through code, I can be found laying
    down some tasty licks on my guitar or exploring the city. -->
  </div>
</template>
<script>
export default {};
